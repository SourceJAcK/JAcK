------------------------------------------------
-- This Source Was Developed By (JAcK) @gg_gd.--
--   This Is The Source Channel @gg_gd .   --
--                - SoUrCe JAcK-                 --
--        -- https://t.me/gg_gd--         --
------------------------------------------------ 
...
download('https://raw.githubusercontent.com/telovf/JAcK/main/JAcK.lua','JAcK.lua')
...
local UserId_Info = LuaTele.searchPublicChat("gg_gd")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/gg_gd"}
},
{
{text = '❲ SoUrCe JAcK ❳', url = "https://t.me/ZJJJE"},
},
...
{
{text = 'programmer Source', url = 't.me/gg_gd'}, 
},
{
{text = 'Developer Source !', url = 't.me/oo_ao'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if text == (Redis:get(TheJAcK.."JAcK:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(TheJAcK.."JAcK:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n▢ ︙أهلآ بك في بوت '..(Redis:get(TheJAcK.."JAcK:Name:Bot") or "بلاك بينك")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/ZJJJE'},{text = '᥀ لتنصيب بوت .', url = 't.me/gg_gd'}, 
},
{
